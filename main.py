...
TELEGRAM_CHANNELS = [
    "prodjob",
    "SearchEditorr",
    # "distantsiya2" — убран: последний пост в канале датирован 2025 годом, канал
    # больше не ведётся, смысла мониторить нет.
    "mediajobs_ru",
    ...
    "editors_video",    # "Монтажеры/Рилс-мейкеры | заказы и вакансии" — очень профильный канал, много Reels/Shorts вакансий
    "vakansii_bez_boltovni",  # "Вакансии без болтовни" — вакансии для киношников в целом (монтаж — часть),
                              # нерелевантные роли (оператор/сценарист и т.п.) отсеет is_relevant()
]
